...
#define WIFI_SSID "IZZI UNZUETA"
#define WIFI_PASSWORD "6142224915"
#define FIREBASE_HOST "integradora-firebase.firebaseio.com" //Do not include https:// in FIREBASE_HOST
